...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/damp-cloud-0d70)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/damp-cloud-0d70
```

A live public deployment of this template is available at [https://damp-cloud-0d70.templates.workers.dev](https://damp-cloud-0d70.templates.workers.dev)
